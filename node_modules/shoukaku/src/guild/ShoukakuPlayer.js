...
class ShoukakuPlayer extends EventEmitter {
    ...
    constructor(node, guild) {
        ...
        this.paused = false;
        /**
         * If this player is currently Looping One song.
         * @type {boolean}
         */
        this.isLoopingOne = false;
        /**
         * If this player is currently Looping all songs.
         * @type {boolean}
         */
    ...
    async setPaused(pause = true) {
     ...
     /**
     * Loops One song for the player
     * @param {boolean} [isLoopingOne=true] true to loop, false to unloop
     * @memberOf ShoukakuPlayer
     * @returns {Promise<ShoukakuPlayer>}
     */
    async setLoopOne() {
        this.isLoopingOne = true;
        this.isLoopingAll = false;
        console.log(`Loop one: ${this.isLoopingOne}`);
    }
     /**
     * Loops One song for the player
     * @param {boolean} [isLoopingAll=true] true to loop, false to unloop
     * @memberOf ShoukakuPlayer
     * @returns {Promise<ShoukakuPlayer>}
     */
    async setLoopAll() {
        this.isLoopingOne = false;
        this.isLoopingAll = true;
        console.log(`Loop all: ${this.isLoopingAll}`);
    }
     /**
     * Loops One song for the player
     * @param {boolean} [isLoopingOff=true] true to loop, false to unloop
     * @memberOf ShoukakuPlayer
     * @returns {Promise<ShoukakuPlayer>}
     */
    async setLoopOff() {
        this.isLoopingAll = false;
        this.isLoopingOne = false;
        console.log(`Loop off: ${this.isLoopingAll} | ${this.isLoopingOne}`);
    }
    /**
